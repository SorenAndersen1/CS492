...
public class FiveDayForecastRepository {
    ...
    private SqlLiteService openWeatherService;
    ...
    public FiveDayForecastRepository() {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        this.openWeatherService = retrofit.create(SqlLiteService.class);
    }
    ...
    public void loadForecast(String location, String units, String apiKey) {
        if (shouldFetchForecast(location, units)) {
            ...
            Call<FiveDayForecast> req;
            req = this.openWeatherService.fetchForecast(location, units, apiKey);
